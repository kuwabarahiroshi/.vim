...
"=============================================================================
if !has("python")
    "call confirm("Python interpreter isn't available. Please be sure to compile Vim with --enable-pythoninterp option.")
    finish
endif
...
elseif filereadable(expand("<sfile>:p:h")."/debugger.py")
  exec ":pyfile " . expand("<sfile>:p:h") . "/debugger.py"
