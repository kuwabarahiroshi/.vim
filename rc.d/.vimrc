...
" -------------------
" Simplenote
nnoremap <leader>sD :VimpleNote -D<CR>
nnoremap <leader>sd :VimpleNote -d<CR>
nnoremap <leader>sl :VimpleNote -l<CR>
nnoremap <leader>sn :VimpleNote -n<CR>
nnoremap <leader>st :VimpleNote -t<CR>
nnoremap <leader>su :VimpleNote -u<CR>
